...
<head>
    ...
    <title>Profil Admin - Bibliothèque</title>
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                if(isset($_SESSION["login_user"])) {
                    ...
                    echo "<tr><td><b>Nom:</b></td><td>".htmlspecialchars($row['nom'])."</td></tr>";
                    echo "<tr><td><b>Prénom:</b></td><td>".htmlspecialchars($row['prenom'])."</td></tr>";
                    ...
                    echo "<h3 style='color: white;'>Veuillez vous connecter pour voir votre profil.</h3>";
                }
                ?>
