...
<head>
    ...
    <title>Livres - Administration</title>
        ...
        <div class="search-container">
            ...
            <?php if(isset($_SESSION["login_user"])): ?>
                <div class="text-center" style="margin-top: 10px;">
                    <a href="add.php" class="btn btn-primary" style="background-color: dodgerblue; border-color: dodgerblue; color: white; font-weight: bold; padding: 10px 20px;">
                        <span class="glyphicon glyphicon-plus"></span> Ajouter un nouveau livre
                    </a>
                </div>
            <?php endif; ?>
        </div>

        <h2 class="text-center" style="margin-top: 30px;">Catalogue des Livres (Admin)</h2>
        ...
        <div class="books-grid">
                ...
                <div class="book-card">
                    ...
                    <div class="book-footer">
                        ...
                        <div class="admin-actions" style="display: flex; gap: 5px;">
                            <a href="edit_book.php?id=<?php echo $row['id']; ?>" class="btn btn-xs btn-info">Modifier</a>
                            <form method="post" style="display: inline;">
                                <input type="hidden" name="book_id" value="<?php echo $row['id']; ?>">
                                <button type="submit" name="delete_book" class="btn btn-xs btn-danger">Supprimer</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            if(isset($_POST["delete_book"])) {
                if(isset($_SESSION["login_user"])) {
                    ...
                    mysqli_stmt_execute($stmt);
                    echo '<script type="text/javascript">alert("Livre supprimé avec succès."); window.location="books.php";</script>';
                } else {
