         ...
         <nav class="navbar navbar-inverse ">
          <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/biblio/index.php">ACCUEIL</a></li>
                        <li><a href="/biblio/books.php">LIVRES</a></li>
                        <li><a href="/biblio/feedback.php">SUGGESTIONS</a></li>
                 </ul >
                 <?php
                 if(isset($_SESSION["login_user"]))
                    {
                        ?>
                         <ul class="nav navbar-nav">
                            <li><a href="/biblio/profile.php">PROFIL</a></li>
                         </ul>

                     <ul class="nav navbar-nav navbar-right">
                        <li><a href="/biblio/profile.php"><div style="color: white">
                            <?php
                     ...
                     <li><a href="/biblio/logout.php"><span class="glyphicon glyphicon-log-in"> DÉCONNEXION</span></a></li>
                     </ul>
                    <?php
                    }
                        else
                       ...
                       <li><a href="/biblio/login.php"><span class="glyphicon glyphicon-log-out"> CONNEXION</span></a></li>
                        <li><a href="/biblio/registration.php"><span class="glyphicon glyphicon-user"> INSCRIPTION</span></a></li>
                    </ul>
                    <?php
                        }
